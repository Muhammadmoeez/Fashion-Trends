...
public class CurtainModel {
    ...
    public CurtainModel(String categoryPrice, String imageURL, String memberPhone, String postCode, String memberCity, String categoryDescription, String shopName) {
